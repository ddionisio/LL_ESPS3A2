...
public class SpriteShapeColorGradientGroup : MonoBehaviour {
	public enum Type {
		Override,
		Multiply,
	}
	...
	public SpriteShapeRenderer[] spriteRenders;
	...
	private void ApplyGradient() {
		if(spriteRenders == null)
			spriteRenders = GetComponentsInChildren<SpriteShapeRenderer>(true);
